...
private void init() {
       listMenu1.addItem(new Model_Menu("News","Bảng Tin",Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("Folder","Dịch Vụ",Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("show","Lịch Hẹn",Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("People","Thành Viên",Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("help1","Phản Hồi",Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("Bill","Hóa Đơn",Model_Menu.MenuType.MENU));
       listMenu1.addItem(new Model_Menu("Management","Quản Lí Ứng Dụng",Model_Menu.MenuType.MENU));
